      ...
      <React.Fragment>
        <div className="content">
          <div className="grid-table">
            ...
            <div className="value">
              {this.state.checkout_count.toLocaleString()}
            </div>
            <div className="value">
              {formatDollars(this.state.checkout_sales)}
            </div>
