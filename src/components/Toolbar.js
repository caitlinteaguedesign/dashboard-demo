...
export class Toolbar extends React.Component
{
   ...
   componentDidMount() 
   {
      ...
      this.setState(getPreferences(this.state), this.switchTheme(this.state.theme));
   }
   ...
   { 
      ...
      */
      ...
      for (var column in this.state.columns) 
      {
         ...
         const modules = thisColumn.moduleIDs.map(moduleID => this.state.modules[moduleID]);
      ...
      return (
         <div className="container">
            ...
            <DragDrop positions={this.state.columns} update={(e) => this.updateDragDrop(e)}>
