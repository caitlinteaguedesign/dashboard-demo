		...
		return (
			<React.Fragment>
	            ...
	            <Section name="Past Hour">
	              	<ValueChecker value={this.state.ordersLastHour} threshold={threshold} comparison={comparison} />
	            </Section>

	            <Section name="Past 24 Hours">
	              	<ValueChecker value={this.state.ordersLast24Hours} threshold={threshold} comparison={comparison} />
	            </Section>
				</div>
